package es.urjc.etsii.cs.comunio.test;
...
@CucumberOptions(features = "features", // Test scenarios
        glue = {"es.urjc.etsii.cs.comunio.cucumber.steps"}, // Steps definitions
        format = {"pretty", // Cucumber report formats and location to store them in phone
                "html:/data/data/es.urjc.etsii.cs.comunio/cucumber-reports/cucumber-html-report",
                "json:/data/data/es.urjc.etsii.cs.comunio/cucumber-reports/cucumber.json",
                "junit:/data/data/es.urjc.etsii.cs.comunio/cucumber-reports/cucumber.xml"
        },
