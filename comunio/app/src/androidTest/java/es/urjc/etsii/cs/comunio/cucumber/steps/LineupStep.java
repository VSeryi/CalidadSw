...
import es.urjc.etsii.cs.comunio.activities.LineupsActivity;
import es.urjc.etsii.cs.comunio.util.ActivityFinisher;
...
public class LineupStep extends ActivityInstrumentationTestCase2<LineupsActivity> {
