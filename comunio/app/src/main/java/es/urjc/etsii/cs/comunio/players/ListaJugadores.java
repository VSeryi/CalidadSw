...
public class ListaJugadores {
    ...
    public boolean add(AbstractPlayer object) {
    ...
    public void setJugadores(ArrayList<AbstractPlayer> jugadores) {
    ...
    public AbstractPlayer set(int index, AbstractPlayer object) {
    ...
    public boolean addAll(Collection<? extends AbstractPlayer> collection) {
    ...
    public List<AbstractPlayer> subList(int start, int end) {
    ...
    public ListIterator<AbstractPlayer> listIterator(int location) {
    ...
    public void add(int index, AbstractPlayer object) {
    ...
    public boolean addAll(int index, Collection<? extends AbstractPlayer> collection) {
    ...
    public ListIterator<AbstractPlayer> listIterator() {
    ...
    public AbstractPlayer get(int index) {
    ...
    public AbstractPlayer remove(int index) {
        return jugadores.remove(index);
    }

    public void cargarJugadores (){
        ArrayList<AbstractPlayer> list=this.getJugadores();
