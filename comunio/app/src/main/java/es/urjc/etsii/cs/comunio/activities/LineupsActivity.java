...
import es.urjc.etsii.cs.comunio.players.BandaDerecha;
import es.urjc.etsii.cs.comunio.players.BandaIzquierda;
import es.urjc.etsii.cs.comunio.players.Defensa;
import es.urjc.etsii.cs.comunio.players.Delantero;
import es.urjc.etsii.cs.comunio.players.ListaJugadores;
import es.urjc.etsii.cs.comunio.players.Portero;
import es.urjc.etsii.cs.comunio.utils.ComunicadorUsuarioLogged;
import es.urjc.etsii.cs.comunio.utils.JugadoresAdapter;
...
public class LineupsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_noticias) {
            ...
            Intent clasf=new Intent(this,LeaderboardActivity.class);
            startActivity(clasf);
            finish();
        } else if (id == R.id.nav_alineacion) {
            //Activity actual
        } else if (id == R.id.nav_equipo) {
            Intent jug=new Intent(this,TeamActivity.class);
            startActivity(jug);
            finish();
        } else if (id == R.id.nav_mercado) {
            Intent jug=new Intent(this,MarketActivity.class);
            startActivity(jug);
            finish();
        } else if (id == R.id.nav_jugadores) {
            Intent jug=new Intent(this,PlayersActivity.class);
            startActivity(jug);
            finish();
