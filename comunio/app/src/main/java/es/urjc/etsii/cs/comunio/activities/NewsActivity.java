...
import es.urjc.etsii.cs.comunio.utils.ComunicadorClasifUpdate;
...
public class NewsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_noticias) {
            ...
            Intent jug=new Intent(this,LineupsActivity.class);
            startActivity(jug);
            finish();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch(i){
            case 3:
                Intent updClas = new Intent(this, LeaderboardActivity.class);
